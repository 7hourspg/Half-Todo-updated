...
import { Image, ScrollView, Text, View,ImageBackground,Button } from 'react-native';
...
function FeedScreen({navigation}) {
  ...
  return (
    ...
    <ImageBackground resizeMode="cover" source={{ uri: Scenery?.SceneryImage }} style={{flex:1,justifyContent:'center',}}>
      <View
        style={{
          flex: 1,
          justifyContent: 'center',
          alignItems: 'center',
          backgroundColor:Scenery? 'transparent':`${theme?.BackgroundColor}`,
        }}
      >
        <Text>Feed!</Text>
